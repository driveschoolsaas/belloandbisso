...
export default function SiteHeader() {
  ...
  return <header className={`site-header ${pathname === "/" ? "home-header" : "internal-header"}`}>
    <Link className="brand logo-brand" href="/" aria-label="Bello & Bisso Charity Foundation, accueil"><img src="/images/bbcf-logo-transparent.png" alt="Bello & Bisso Charity Foundation" /></Link>
    ...
    <Link className="header-cta" href="/engager">Soutenir <span>↗</span></Link>
  </header>;
}
